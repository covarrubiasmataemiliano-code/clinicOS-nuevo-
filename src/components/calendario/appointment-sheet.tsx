...
export function AppointmentSheet({
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="right" className="flex flex-col w-full px-0 sm:max-w-md bg-background">
        ...
        {/* Acciones */}
        {canAct && (
          <div className="px-6 pb-6 pt-4 bg-background border-t border-border">
